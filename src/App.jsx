...
function App() {
  return (
    <div className="pb-[92px] pt-[38px] xl:pb-[125px] xl:pt-16">
      ...
      <main className="3xl:justify-center mt-16 flex flex-col items-center gap-[87px] xl:mt-32 xl:flex-row-reverse">
        {/* illustration */}
        <div className="3xl:mr-0 -mr-[139px] min-w-[482px] max-w-[916px] 2xl:-mr-[268px] 2xl:min-w-[916px]">
          <img
            src={illustration}
